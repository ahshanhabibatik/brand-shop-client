            ...
            <div data-aos="fade-up" className="grid  py-11 grid-cols-1 lg:grid-cols-4">
                ...
                <div className="col-span-2">
                    <div className="">
                        ...
                        <p className="text-center text-white font-bold mt-5">New to Trend Wave Shop.Please<Link className="text-blue-600 underline font-bold" to={'/register'}> Register</Link></p>
                    </div>
                </div>
                <div>
